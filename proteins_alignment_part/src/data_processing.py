...
def process_results(requested_data: str) -> tuple:
    """
    Gets the needed information about alignment from the requested html page.

    :param requested_data: data from the page of the IPBA website.
    :return: needed information about alignment, urls of the images.
    """
...
def write_text_results(alignment_information: list) -> None:
    """
    Gets the needed information about alignment from the requested html page.

    :param alignment_information: needed information about alignment from the IPBA website.
    :return: creates files with gotten data in the result folder.
    """
...
def write_images_results(images_urls: list) -> None:
    """
    Saves images from the IPBA website of the aligned structures.

    :param images_urls: urls of the images.
    :return: saves images from the internet.
    """
